...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            ...
            <form method="POST" action="{{Route('updateStudentAction')}}" id="formUpdateSiswa" enctype="multipart/form-data">
                <input type="string" value="{{$data->id_student}}" name="id" hidden>
                @csrf
                <div class="card-body">
                    <!-- data siswa -->
                    <div class="card">
